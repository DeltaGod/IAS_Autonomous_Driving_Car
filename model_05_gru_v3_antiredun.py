...
ventanas para cortar el solape entre secuencias casi idénticas (sliding window a 22fps).
Última palanca "entrenable" sin tocar el dataset. F1 macro dirección (val) = 0.550:
NO mejoró sobre GRU v2 (0.554), pero dio el MEJOR MAE de velocidad (~17). Confirma el
...
CFG = Config(
    # IDÉNTICA a GRU v2 + anti-redundancia de ventanas en train
