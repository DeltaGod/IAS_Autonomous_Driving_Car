...
====================================================================
Primer intento temporal. F1 macro direccion (val) = 0.514. Overfit desde la epoca 1
(STOP recall colapso a ~0.26: el modelo se refugio en FORWARD). Quedo por DEBAJO del
...
CFG = Config(
    ...
    # optimizacion (batch chico por la RAM unificada de la Jetson)
