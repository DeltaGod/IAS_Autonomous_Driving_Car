...
F1 macro direccion (val) = 0.544 ~= GRU v2 (0.554), dentro del ruido. Confirma que
GRU vs LSTM es decision de 2o orden: el LSTM tiene +33% de params (mas overfit) y a
...
CFG = Config(
    # IDENTICA a GRU v2 salvo el tipo de celda recurrente
