...
=================================================================
GRU con MAS regularizacion para frenar el overfit de v1: hidden mas chico (64),
dropout 0.5, weight_decay 1e-3 y 25 epocas. F1 macro direccion (val) = 0.554 (mejor
de los temporales). Recupero el STOP recall vs v1, pero igual NO supera al per-frame.
