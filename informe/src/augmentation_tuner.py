...
# =================================================================
    # HIPERPARAMETROS DE COLOR JITTER (Stress Test)
    # =================================================================
    ...
    jitter_transform = T.ColorJitter(
        ...
        contrast=0.6,    # Fuerza la diferencia entre la linea blanca y el piso gris
    ...
    # Posicion [0,0]: Imagen Original
    axes[0, 0].imshow(original_img)
    axes[0, 0].set_title("Original")
    axes[0, 0].axis('off')

    # Generar 15 variaciones estocasticas
    for i in range(1, 16):
        row = i // 4
        col = i % 4
        
        # Aplicar la transformacion aleatoria
    ...
    print("Grid generado: 'tuning_grid.png'. Abrelo y analiza las variaciones.")
    plt.show()

if __name__ == "__main__":
    # Puedes pasar la ruta por consola o cambiar el string aqui directamente.
    ...
    if len(sys.argv) > 1:
        ...
        # Reemplaza esto con una ruta valida real que saques de dataset_train.csv
