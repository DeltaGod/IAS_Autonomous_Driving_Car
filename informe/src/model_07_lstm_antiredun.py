...
================================================================
IDENTICO a model_05_gru_v3_antiredun (GRU v2 regularizado + seq_window_step=4) pero
con celda LSTM en vez de GRU. Completa el grid GRU/LSTM x (con/sin anti-redundancia):
  model_03 GRU v2  |  model_04 LSTM (=v2)  |  model_05 GRU+antiredun  |  model_07 LSTM+antiredun
Target = direccion 3-clases + velocidad por motor (nn_sequence), igual que model_05.

Hiperparametros CONGELADOS abajo (= model_05, solo cambia rnn_type). Motor en nn_sequence.py.
...
CFG = Config(
    # IDENTICA a model_05 salvo el tipo de celda recurrente (GRU -> LSTM)
